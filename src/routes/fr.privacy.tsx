...
Le site ne pose pas de cookies lui-même. Si votre navigateur garde quelque chose, cela se limite à l'état technique standard nécessaire au chargement des pages (cache, etc.) et n'est ni lu ni traité.

La seule situation où une information personnelle me parvient est si vous choisissez de m'écrire directement via la page contact. Dans ce cas, je reçois uniquement ce que vous choisissez d'envoyer et je l'utilise seulement pour répondre.
...
Si vous avez une question sur cette politique, ou si vous voulez supprimer une correspondance envoyée, contactez-moi via la page contact.`;
