...
> Goals, constraints, and simplified trigger-map framing.

**Document:** Trigger Map - Strategic Context
**Created:** 2026-04-21
**Status:** Complete
...
### Tertiary Objective: Permit Emergent Opportunity

- **Statement:** Allow genuine intersections of interest to surface without designing a funnel.
- **Measure:** RSS and contact are available, but neither dominates the experience.
- **Target:** Collaborators or professional observers can find enough evidence and context to decide whether to reach out.
- **Impact:** Opportunities remain pull-based and compatible with the archive's purpose.

---

## Strategic Constraints

- Do not convert the site into a pitch deck or resume funnel.
- Do not use inflated positioning language.
- Do not make "Selected" imply conventional best-work ranking.
- Do not make collections fixed identities; they are flexible access routes.
- Do not make Notes a raw public diary.
- Do not add analytics, contact flows, search, or CMS complexity until content volume or usage proves the need.

---

## Visitor Modes

This project uses visitor modes instead of marketing personas. A visitor mode describes why someone is here now, not a fixed customer identity.

| Mode | Priority | Core Need |
|------|----------|-----------|
...
- [02-future-nathan.md](./02-future-nathan.md) - Primary visitor mode
- [03-curious-observer.md](./03-curious-observer.md) - Exploration visitor mode
- [04-potential-collaborator.md](./04-potential-collaborator.md) - Collaboration visitor mode
- [05-professional-observer.md](./05-professional-observer.md) - Professional inference visitor mode
- [06-feature-impact-analysis.md](./06-feature-impact-analysis.md) - Prioritized site structures
- [07-key-insights.md](./07-key-insights.md) - Design implications
