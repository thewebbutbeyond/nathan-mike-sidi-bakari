...
> How the simplified Trigger Map informs design and development decisions.
...
- Explain the archive through structure, not a long manifesto.
- Expose main routes: Selected, Timeline, Collections, Notes.
- Avoid hero copy that sounds like a resume pitch.
- Signal that public access is open-ended and non-linear.
...
- Feel editorial and curated.
- Prioritize clarity and rereadability.
- Support RSS.
...
- Be available but visually quiet.
- Use language around genuine intersections of interest.
- Avoid "book a call" or conversion framing.

---

## Emotional Transformation Goals

- **Future Nathan:** "I can see what I made, why it mattered, and how it connects."
- **Curious Observer:** "I understand how to explore this without being sold to."
- **Potential Collaborator:** "I can tell whether there is a real overlap worth contacting about."
- **Professional Observer:** "I can infer capability from concrete work and trajectory."
...
- [01-strategic-context.md](./01-strategic-context.md) - Goals and constraints
...
- [06-feature-impact-analysis.md](./06-feature-impact-analysis.md) - Feature priorities
