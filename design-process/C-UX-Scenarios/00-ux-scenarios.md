...
> Every artifact is accessible through identity and time, with selected entry points reducing friction for new visitors.
...
|---|----------|----------------------|--------------|--------|
| 01 | [Orienting at the Portal](./01-orienting-at-the-portal/01-orienting-at-the-portal.md) | Curious Observer | Home / Portal to Selected to artifact | Complete |
| 02 | [Tracing a Domain](./02-tracing-a-domain/02-tracing-a-domain.md) | Professional Observer | Collection to artifact to related work | Complete |
| 03 | [Following Time](./03-following-time/03-following-time.md) | Future Nathan | Timeline to milestone to related artifact | Complete |
| 04 | [Inspecting an Artifact](./04-inspecting-an-artifact/04-inspecting-an-artifact.md) | Potential Collaborator | Artifact detail to context and overlap | Complete |
| 05 | [Reading Notes](./05-reading-notes/05-reading-notes.md) | Curious Observer | Notes index to note to RSS | Complete |
| 06 | [Finding Contact](./06-finding-contact/06-finding-contact.md) | Potential Collaborator | Relevant artifact to About to Contact | Complete |

---

## Page Coverage Matrix

| Page / View | 01 Portal | 02 Domain | 03 Time | 04 Artifact | 05 Notes | 06 Contact |
|-------------|-----------|-----------|---------|-------------|----------|------------|
| Home / Portal | Primary | - | - | - | - | - |
| Selected | Primary | - | - | - | - | - |
| Collections | - | Primary | - | - | - | - |
...
| Timeline | - | - | Primary | - | - | - |
| Artifact Detail | Primary | Primary | Primary | Primary | - | Primary |
| Related Artifacts | - | Primary | Primary | Primary | - | Primary |
| Notes Index | - | - | - | - | Primary | - |
| Note Detail | - | - | - | - | Primary | - |
| RSS | - | - | - | - | Primary | - |
| About | - | - | - | - | - | Primary |
...
- Show title, date, type, summary, collection memberships, tags, status, role, process/context, links, and related artifacts.
- Support unfinished, historical, and polished artifacts without forcing one presentation mode.

### Collections

- Support Engineer, Entrepreneur, Investor, and Artist.
- Allow artifacts to appear in multiple collections.
